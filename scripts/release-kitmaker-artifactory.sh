...
create_and_upload "main" "x86_64" "ubuntu22.04-amd64" "ubuntu20.04-amd64" "ubuntu18.04-amd64" "centos7-x86_64"

# Create archive for sbsa linux distributions
create_and_upload "main" "sbsa" "ubuntu22.04-arm64" "ubuntu20.04-arm64" "ubuntu18.04-arm64" "centos7-aarch64"
...
create_and_upload "main" "aarch64" "ubuntu22.04-arm64" "ubuntu20.04-arm64" "ubuntu18.04-arm64" "centos7-aarch64"

# Create archive for ppc64le linux distributions
create_and_upload "main" "ppc64le" "ubuntu22.04-ppc64le" "ubuntu20.04-ppc64le" "ubuntu18.04-ppc64le" "centos8-ppc64le"
